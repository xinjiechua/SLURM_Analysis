...
public class TimeLimitMonthGraphPanel extends JPanel{
	public void paint(Graphics g) {
		...
		String title = "Number of jobs exceeded time limit by months";
		int scaleYnum = 4;
		int scaleYdiff = 25;
		int scaleYini = 0;
		...
		g2D.drawString("Number of jobs exceeded time limit",leftBorder-60 ,upBorder-30 );
